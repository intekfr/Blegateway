    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
      ...
      <div class="eqLogicThumbnailContainer">
        <div class="cursor eqLogicAction" data-action="add" style="background-color : #ffffff; height : 140px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;">
          ...
          <span style="font-size : 1.1em;position:relative; top : 15px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#00979c">
      ...
      <legend>
        <i class="fa fa-table"></i> {{Mes BLE Gateway Tag}} </legend>
      <div class="eqLogicThumbnailContainer">
        <?php
      foreach ($eqLogics as $eqLogic) {
          ...
          <div class="col-sm-6">
            <form class="form-horizontal">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">{{Type de Tag}}</label>
                  <div class="col-sm-3">
                    <select class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="type">
                      <option value="iBS01">iSB01</option>
                      <option value="iSB01H">iSB01H</option>
                      <option value="iSB01G">iSB01G</option>
                      <option value="iSB01T">iSB01T</option>
                      <option value="iSB01RG">iSB01RG</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
